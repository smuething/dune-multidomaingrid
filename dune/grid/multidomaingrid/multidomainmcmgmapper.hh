...
public:
  ...
  typedef typename GV::Grid::SubDomainType SubDomainType;
  ...
  */
  ...
  int map (SubDomainType subDomain, const EntityType& e) const
  {
  ...
  */
  int size (SubDomainType subDomain) const
  {
    return _n[subDomain];
  }
  ...
  */
  template<class EntityType>
  bool contains (SubDomainType subDomain, const EntityType& e, IndexType& result) const
  {
  ...
  */
  ...
  bool contains (SubDomainType subDomain, const typename GV::template Codim<0>::Entity& e, int i, IndexType& result) const
  {
